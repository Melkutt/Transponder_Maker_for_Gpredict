...
class TrspGenerator:
    def __init__(self, root):
        self.root = root
        self.root.title("Satellite Transponder Maker v1.1")
        ...
        # --- Static Info Text at the bottom (Offline Version) ---
        info_frame = tk.Frame(root)
        info_frame.pack(side="bottom", fill="x", pady=10)
        
        tk.Label(info_frame, text="Created by MELHUL", 
                 font=("Arial", 8, "bold"), fg="gray").pack()
        tk.Label(info_frame, text="Created by MELHUL", 
